...
[만들게 된 배경]  
판타지 느낌의 그래픽으로 로그라이크 혹은 유사 장르의 게임을 
...
|속성|영문명칭|설명|비고|
|:----:|:----:|:----:|:----:|
|1|마법사|Slime|가장기본적인 적으로 쉽게 제압할 수 있는 몹입니다|
|2|거대|BSlime|크기가 커진 슬라임으로 일반슬라임보다 강력합니다|
...
|2|hp가 100일때|거대마법사공격(hp-40)|거대슬라임이 공격을 한 대 적중시켰을경우|
