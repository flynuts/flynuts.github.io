...
![123456](https://user-images.githubusercontent.com/92343121/139588861-4fa7fd55-3bff-43e7-8a46-fbe189aa2c86.png)
...
메인화면엔 게임시작 옵션 게임종료 버튼이 있습니다

게임 시작시 처음 캐릭터는 마을에서 스폰이 됩니다

조작은 방향키로이동 점프는 스페이스바 공격은 A로 가능합니다

화면에는 플레이어의 현재 체력,마력,스킬정보, 미니맵이 표시됩니다

마을에 존재하는 던전을 클리어시 다음 마을로 향하는 루트가 해금됩니다

게임에 존재하는 모든 던전을 클리어할시 게임은 끝이나게 됩니다

플레이어가 사망시 진행중이던 던전상황은 초기화되고 마을로 다시 리스폰하게 됩니다
